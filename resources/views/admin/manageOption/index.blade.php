          ...
          <table class="table table-striped table-bordered table-hover" id="categoryList">
            <thead>
              <tr align="center">
                ...
                <th class="table-Sort" style="width: 10%;" data-sort="optionName">Option Name</th>
                <th class="table-Sort" style="width: 10%;"data-sort="optionValue">Values</th>
            ...
            <tbody>
              <tr class="odd gradeX" align="center">
                ...
                <td>
                  <button id="addVariant" class="btn btn-info" data-toggle="modal" data-target="#--optionValue?ID---">+</button>
                </td>
              </tr>

        ...
        <div class="modal-body">
          <form class="form-horizontal" action="">
            <div class="form-group">
              <label class="control-label col-sm-5" for="companyName">Company Name</label>
              <div class="col-xs-10">
          ...
          <table class="table table-striped table-bordered table-hover" id="categoryList">
            <thead>
              <tr align="center">
                ...
                <th class="table-Sort" style="width: 10%;" data-sort="customer">Company Name</th>
                <th class="table-Sort" style="width: 10%;"data-sort="orderDate">Phone</th>
